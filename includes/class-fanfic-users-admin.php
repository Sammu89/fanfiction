				...
				<div class="tab-content">
					...
					<div class="notice notice-info inline">
						...
						<ul>
							...
							<li><strong><?php esc_html_e( 'Banned:', 'fanfiction-manager' ); ?></strong> <?php esc_html_e( 'Suspended users can log in but cannot create/edit content. Their stories are hidden from public view. A notice displays "Your account has been suspended."', 'fanfiction-manager' ); ?></li>
						</ul>
						<h3><?php esc_html_e( 'User Management Guidelines', 'fanfiction-manager' ); ?></h3>
						<ul>
							<li><strong><?php esc_html_e( 'Ban:', 'fanfiction-manager' ); ?></strong> <?php esc_html_e( 'Banned users can still log in but cannot create/edit content. Their stories are hidden from public view. Fanfiction admins cannot ban other admins; moderators cannot ban other moderators.', 'fanfiction-manager' ); ?></li>
