...
$template = fanfic_inject_dynamic_action_buttons_placeholder( $template, 'view-profile' );
...
$rendered_template = str_replace( '[content-actions]', $action_buttons_markup, $rendered_template );
