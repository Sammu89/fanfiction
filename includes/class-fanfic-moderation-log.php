...
class Fanfic_Moderation_Log {
	...
	private static function get_action_label( $action ) {
		$labels = array(
			...
			'reporter_blacklisted' => __( 'Blacklisted Reporter', 'fanfiction-manager' ),
			'message_sender_blacklisted' => __( 'Blacklisted Author Message Sender', 'fanfiction-manager' ),
			'reporter_unblacklisted' => __( 'Removed Reporter From Blacklist', 'fanfiction-manager' ),
			'message_sender_unblacklisted' => __( 'Removed Author From Blacklist', 'fanfiction-manager' ),
