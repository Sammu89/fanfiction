	...
	public static function enqueue_admin_assets( $hook ) {
		...
		$localize_data = array(
			...
			'strings' => array(
				...
				'reviewChangesLabel'  => __( 'Review modifications', 'fanfiction-manager' ),
				'hideReviewLabel'     => __( 'Hide review', 'fanfiction-manager' ),
				...
				'reportMessageTitle'  => __( 'Report Message', 'fanfiction-manager' ),
				'reportMessageEmpty'  => __( 'This report does not include a message.', 'fanfiction-manager' ),
				'reportLoading'       => __( 'Loading message...', 'fanfiction-manager' ),
				'reportBlockSubmitting'=> __( 'Blocking...', 'fanfiction-manager' ),
