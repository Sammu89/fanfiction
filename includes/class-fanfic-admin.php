	...
	public static function enqueue_admin_assets( $hook ) {
		...
		$localize_data = array(
			...
			'strings' => array(
				...
				'compareLabel'        => __( 'Compare Changes', 'fanfiction-manager' ),
				'hideCompareLabel'    => __( 'Hide Comparison', 'fanfiction-manager' ),
				'compareLoading'      => __( 'Loading comparison...', 'fanfiction-manager' ),
