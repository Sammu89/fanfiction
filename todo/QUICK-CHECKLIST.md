...
- [ ] Add `[edit-chapter-button]` to `single-fanfiction_chapter.php`
...
- [ ] Add to `single-fanfiction_chapter.php`
...
templates/single-fanfiction_chapter.php     (add edit button)
...
code templates/single-fanfiction_chapter.php
